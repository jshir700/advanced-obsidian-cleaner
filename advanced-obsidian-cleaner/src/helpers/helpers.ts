...
export function getExtensions(_settings: FileCleanerSettings): string[] {
  // CleanRule system replaces attachmentExtensions.
  // Return empty array; callers should use the rule-based system instead.
  return [];
}
